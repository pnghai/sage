...
add_filter('new_royalslider_skins', __NAMESPACE__ . '\\new_royalslider_add_custom_skin', 10, 2);
function new_royalslider_add_custom_skin($skins) {
    $skins['rsLeftDefaultInv'] = array(
        'label' => 'Left Thumbs',
        'path' => get_stylesheet_directory_uri() . '/royalslider/left-default-inverted/rs-left-default-inverted.css'  // get_stylesheet_directory_uri returns path to your theme folder
    );
    return $skins;
}